...
interface ApiConfigImporterProps {
  onImportSuccess: () => void;
}

export default function ApiConfigImporter({ onImportSuccess }: ApiConfigImporterProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="flex justify-center gap-4">
        ...
        {/* Input de fichier caché mais accessible */}
        <input
          type="file"
